  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-profit': '0 0 20px -5px rgba(16, 185, 129, 0.4)',
        'glow-risk': '0 0 20px -5px rgba(244, 63, 94, 0.4)',
      ...
      keyframes: {
        'glow-pulse': {
          '0%': { boxShadow: '0 0 15px -3px rgba(6, 182, 212, 0.3)' },
          '100%': { boxShadow: '0 0 25px -3px rgba(6, 182, 212, 0.6)' },
        },
        'data-stream': {
